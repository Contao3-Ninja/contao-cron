...
$GLOBALS['TL_LANG']['XPL']['cron_elements']['0']['1'] = 'Основной синтаксис времени:<br/><br/><pre> begin[-end][/step] </pre><br/>Части заключенные в скобки являются необязательными. Независимыми элементами могут быть минуты, часы, дни месяца, дни недели или месяцы. Часть <code>begin[-end]</code> может быть заменена * (звездочкой) которая включает их <em>все</em>.<br/>Пример правильных элементов:<br/><br/><pre> 5 minute,hour,day,... number 5 3-5 minutes,hours,days,... 3,4,5 5-10/2 minutes,hours,days,... 5,7,9 * all minutes,hours,days,... */3 minutes,hours,days,... 0,3,6,... </pre>';
